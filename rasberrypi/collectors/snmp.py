...
try:
    ...
    # PySNMP 7.x uses next_cmd, not walk_cmd
    from pysnmp.hlapi.v3arch.asyncio import next_cmd as walk_cmd
except ImportError:
    try:
        ...
        # Fallback for alternative packaging structures
        ...
        from pysnmp.hlapi.asyncio import nextCmd as walk_cmd
